...
token = '0V82W29Ad0cK3LrkAQ4eggfjnzRY7jqA7wEEL2GpLwp'
...
def draw_boundary(img,classifier,scaleFactor,minNeighbors,color,clf): 
      ...
      for(x,y,w,h) in features:
            ...
            if id ==2 :
                  ...
                  if 40>=con<=100:
                        text = "Pla"
                        cv2.putText(img,"Pla",(x,y-4),cv2.FONT_HERSHEY_SIMPLEX,0.8,color,1)
                        line(text)
...
#cap = cv2.VideoCapture('http://172.20.10.13:10324/videostream.cgi?user=admin&pwd=pajaree1418')
